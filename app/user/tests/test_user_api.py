...
class PublicUserApiTests(TestCase):
    ...
    def setUp(self):
        self.client = APIClient()  # Initialize the APIClient for testing.
    ...
    def test_user_with_email_exists_error(self):
        """Tests an error returned if the same email exists."""
        payload = {
            'email': 'test@example.com',
            'password': 'testpass123',
            'name': 'Test Name',
    ...
    def test_password_too_short_error(self):
        ...
        # Checks that the user has not been created since the password is too short
...
class PrivateUserApiTests(TestCase):
    ...
    def test_update_user_profile(self):
        """Test for updating the authenticated user profile."""
